...
import "./FishCleaningWindow.css";



function FishCleaningWindow ({soapOption, setActivePetActivity}){
    ...
    return (
        ...
        <div className = {`PetWindowBorder PetWindowBorder-fish`}>
            <h2 className={`PetWindowSign PetWindowSign-fish`}> 
                <ProgressBar
...
export default FishCleaningWindow;