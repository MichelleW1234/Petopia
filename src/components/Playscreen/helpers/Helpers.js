export const PlayWithPet = (PetTimeStamps, setPetTimeStamps, PetList, setPetList, ActivePetNumber, minimum) => {
    ...
    if (now - updatedPetTimeStamps[ActivePetNumber][2][0] < minimum){
    //Over fed
    ...
    updatedPetTimeStamps[ActivePetNumber][2][0] = now;
