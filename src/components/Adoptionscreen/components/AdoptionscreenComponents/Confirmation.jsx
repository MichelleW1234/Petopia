    ...
    return (
        <>
            ...
            <div className = "Confirmation_ComponentContainer-Structure">
                ...
                <div className="UIStapleElements_ComponentContainer-Structure--Normal UIStapleElements_ComponentContainer-Color--Screens_ Confirmation_ComponentContainer-Structure--Name">
                    <input 
            ...
            <div className = "Confirmation_ComponentContainer-Structure--Checking">
                ...
                <div className = "MiscellaneousElements_ComponentContainer-Structure--Row">
                    <button className = "UIStapleElements_ComponentButtonPill-Structure--Normal UIStapleElements_ComponentButtonPill-Color--Screens_Normal" onClick = {() => undo()}> Undo Selection </button>
                    <Link to = "/home" className = "UIStapleElements_ComponentButtonPill-Structure--Normal UIStapleElements_ComponentButtonPill-Color--Screens_Normal" onClick = {(e) => nameChecking(e)}> Confirm Selection </Link>
                </div>
            </div>
        </>
    );
