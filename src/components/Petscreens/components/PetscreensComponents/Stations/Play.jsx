...
import { manageHealth, pauseAudio, quit } from "../../../helpers/Helpers.js";
...
function Play ({playOptions, playDesiredOption, setPlayDesiredOption, setPlayOpenFlag}){
    ...
    const PlaySelectedGameWindow = playSelection !== -1 ? 
                                        playOptions[playSelection][optionGameKey]
                                        : null;
    ...
    useEffect(() => {
        ...
        const preloadImages = [...playOptions.map(item => item[optionImageKey])];
        ...
        <div className = "UIStapleElements_BackgroundOverlay-Structure--FloatingFlag UIStapleElements_BackgroundOverlay-Color--FloatingFlag--Station">
            ...
            {!playDone ? (
                ...
                <div className="MiscellaneousElements_ComponentContainer-Structure--GlobalRow">
                    <button className = "UIStapleElements_ComponentButtonPill-Structure--GlobalClick UIStapleElements_ComponentButtonPill-Color--GlobalClick--FloatingFlagStation" onClick = {() => quit(playAudioRef, setPlayOpenFlag)}>Quit <br/> [esc]</button>
                ...
                <div className="MiscellaneousElements_ComponentContainer-Structure--GlobalRow">
                    ...
                    <button className = "UIStapleElements_ComponentButtonPill-Structure--GlobalClick UIStapleElements_ComponentButtonPill-Color--GlobalClick--FloatingFlagStation" onClick = {() => screenFlagCloser(setPlayOpenFlag)}>Done <br/> [return]</button>
                </div>
