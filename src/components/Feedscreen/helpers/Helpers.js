export const FeedPet = (PetTimeStamps, setPetTimeStamps, PetList, setPetList, ActivePetNumber, minimum) => {
    ...
    if (now - updatedPetTimeStamps[ActivePetNumber][0][0] < minimum){
    //Over fed
    ...
    updatedPetTimeStamps[ActivePetNumber][0][0] = now;
